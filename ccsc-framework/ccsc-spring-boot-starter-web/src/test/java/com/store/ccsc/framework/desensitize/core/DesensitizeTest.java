package com.store.ccsc.framework.desensitize.core;

import com.store.ccsc.framework.common.util.json.JsonUtils;
import com.store.ccsc.framework.desensitize.core.annotation.Address;
import com.store.ccsc.framework.desensitize.core.regex.annotation.EmailDesensitize;
import com.store.ccsc.framework.desensitize.core.regex.annotation.RegexDesensitize;
import com.store.ccsc.framework.desensitize.core.slider.annotation.*;
import lombok.Data;
