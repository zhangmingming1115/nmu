package com.store.ccsc.framework.operatelog.core.aop;
...
import com.store.ccsc.framework.common.util.monitor.TracerUtils;
...
import com.store.ccsc.framework.operatelog.core.service.OperateLog;
import com.store.ccsc.framework.operatelog.core.service.OperateLogFrameworkService;
import com.store.ccsc.framework.web.core.util.WebFrameworkUtils;
...
import static com.store.ccsc.framework.common.exception.enums.GlobalErrorCodeConstants.INTERNAL_SERVER_ERROR;
import static com.store.ccsc.framework.common.exception.enums.GlobalErrorCodeConstants.SUCCESS;
...
public class OperateLogAspect {
    ...
    public Object around(ProceedingJoinPoint joinPoint, Operation operation) throws Throwable {
        ...
        com.store.ccsc.framework.operatelog.core.annotations.OperateLog operateLog = getMethodAnnotation(joinPoint,
                com.store.ccsc.framework.operatelog.core.annotations.OperateLog.class);
    ...
    public Object around(ProceedingJoinPoint joinPoint,
                         com.store.ccsc.framework.operatelog.core.annotations.OperateLog operateLog) throws Throwable {
        return around0(joinPoint, operateLog, null);
    }

    private Object around0(ProceedingJoinPoint joinPoint,
                           com.store.ccsc.framework.operatelog.core.annotations.OperateLog operateLog,
