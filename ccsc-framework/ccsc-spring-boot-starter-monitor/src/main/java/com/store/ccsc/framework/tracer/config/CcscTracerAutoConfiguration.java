package com.store.ccsc.framework.tracer.config;

import com.store.ccsc.framework.common.enums.WebFilterOrderEnum;
import com.store.ccsc.framework.tracer.core.aop.BizTraceAspect;
import com.store.ccsc.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "ccsc.tracer", value = "enable", matchIfMissing = true)
public class CcscTracerAutoConfiguration {
