package com.store.ccsc.module.infra.controller.admin.logger.vo.apierrorlog;
...
import com.store.ccsc.module.infra.enums.DictTypeConstants;
...
public class ApiErrorLogRespVO {
    ...
    @DictFormat(com.store.ccsc.module.system.enums.DictTypeConstants.USER_TYPE)
