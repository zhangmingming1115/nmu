package com.store.ccsc.module.infra.service.demo.demo03.inner;
...
import com.store.ccsc.module.infra.controller.admin.demo.demo03.inner.vo.Demo03StudentInnerPageReqVO;
import com.store.ccsc.module.infra.controller.admin.demo.demo03.inner.vo.Demo03StudentInnerSaveReqVO;
import com.store.ccsc.module.infra.dal.dataobject.demo.demo03.Demo03CourseDO;
import com.store.ccsc.module.infra.dal.dataobject.demo.demo03.Demo03GradeDO;
import com.store.ccsc.module.infra.dal.dataobject.demo.demo03.Demo03StudentDO;
import com.store.ccsc.module.infra.dal.mysql.demo.demo03.inner.Demo03CourseInnerMapper;
import com.store.ccsc.module.infra.dal.mysql.demo.demo03.inner.Demo03GradeInnerMapper;
import com.store.ccsc.module.infra.dal.mysql.demo.demo03.inner.Demo03StudentInnerMapper;
...
import static com.store.ccsc.module.infra.enums.ErrorCodeConstants.DEMO03_STUDENT_NOT_EXISTS;
...
public class Demo03StudentInnerServiceImpl implements Demo03StudentInnerService {
    ...
    private void updateDemo03CourseList(Long studentId, List<Demo03CourseDO> list) {
        ...
        List<List<Demo03CourseDO>> diffList = CollectionUtils.diffList(oldList, list, (oldVal, newVal) -> {
