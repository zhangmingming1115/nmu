package com.store.ccsc.module.infra.service.codegen.inner;
...
import com.store.ccsc.framework.common.exception.util.ServiceExceptionUtil;
...
import com.store.ccsc.framework.common.util.date.DateUtils;
...
import com.store.ccsc.framework.excel.core.annotations.DictFormat;
import com.store.ccsc.framework.excel.core.convert.DictConvert;
...
import com.store.ccsc.framework.operatelog.core.enums.OperateTypeEnum;
...
//                SystemUtil.getJavaInfo().isJavaVersionAtLeast(1700); // 17.00 * 100
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "ccsc-module-${table.moduleName}/" + // 顶级模块
                "ccsc-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "ccsc-module-${table.moduleName}/" + // 顶级模块
                "ccsc-module-${table.moduleName}-biz/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "ccsc-ui-${sceneEnum.basePackage}-vue2/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "ccsc-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }
