package com.store.ccsc.module.infra.service.logger;
...
import com.store.ccsc.module.infra.api.logger.dto.ApiErrorLogCreateReqDTO;
import com.store.ccsc.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import com.store.ccsc.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import com.store.ccsc.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import com.store.ccsc.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static com.store.ccsc.framework.common.util.date.LocalDateTimeUtils.*;
...
import static com.store.ccsc.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static com.store.ccsc.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("ccsc-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("ccsc-test");
