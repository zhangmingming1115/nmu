package com.store.ccsc.module.infra.service.codegen;

import cn.hutool.core.collection.ListUtil;
import cn.hutool.core.map.MapUtil;
import com.store.ccsc.framework.common.pojo.PageResult;
import com.store.ccsc.framework.test.core.ut.BaseDbUnitTest;
import com.store.ccsc.module.infra.controller.admin.codegen.vo.CodegenCreateListReqVO;
import com.store.ccsc.module.infra.controller.admin.codegen.vo.CodegenUpdateReqVO;
import com.store.ccsc.module.infra.controller.admin.codegen.vo.column.CodegenColumnSaveReqVO;
import com.store.ccsc.module.infra.controller.admin.codegen.vo.table.CodegenTablePageReqVO;
import com.store.ccsc.module.infra.controller.admin.codegen.vo.table.DatabaseTableRespVO;
import com.store.ccsc.module.infra.dal.dataobject.codegen.CodegenColumnDO;
import com.store.ccsc.module.infra.dal.dataobject.codegen.CodegenTableDO;
import com.store.ccsc.module.infra.dal.mysql.codegen.CodegenColumnMapper;
import com.store.ccsc.module.infra.dal.mysql.codegen.CodegenTableMapper;
import com.store.ccsc.module.infra.enums.codegen.CodegenFrontTypeEnum;
import com.store.ccsc.module.infra.enums.codegen.CodegenSceneEnum;
import com.store.ccsc.module.infra.enums.codegen.CodegenTemplateTypeEnum;
import com.store.ccsc.module.infra.framework.codegen.config.CodegenProperties;
import com.store.ccsc.module.infra.service.codegen.inner.CodegenBuilder;
import com.store.ccsc.module.infra.service.codegen.inner.CodegenEngine;
import com.store.ccsc.module.infra.service.db.DatabaseTableService;
import com.store.ccsc.module.system.api.user.AdminUserApi;
import com.store.ccsc.module.system.api.user.dto.AdminUserRespDTO;
...
import static com.store.ccsc.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static com.store.ccsc.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static com.store.ccsc.framework.common.util.object.ObjectUtils.cloneIgnoreId;
import static com.store.ccsc.framework.test.core.util.AssertUtils.assertPojoEquals;
import static com.store.ccsc.framework.test.core.util.AssertUtils.assertServiceException;
import static com.store.ccsc.framework.test.core.util.RandomUtils.*;
import static com.store.ccsc.module.infra.enums.ErrorCodeConstants.*;
