package com.store.ccsc.module.system.controller.admin.logger.vo.operatelog;
...
import com.store.ccsc.module.system.enums.DictTypeConstants;
...
public class OperateLogRespVO {
    ...
    @Schema(description = "Java 方法名", requiredMode = Schema.RequiredMode.REQUIRED, example = "com.store.ccsc.adminserver.UserController.save(...)")
