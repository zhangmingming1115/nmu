package com.store.ccsc.module.system.service.user;

import cn.hutool.core.util.RandomUtil;
import com.store.ccsc.framework.common.enums.CommonStatusEnum;
import com.store.ccsc.framework.common.exception.ServiceException;
import com.store.ccsc.framework.common.pojo.PageResult;
import com.store.ccsc.framework.common.util.collection.ArrayUtils;
import com.store.ccsc.framework.common.util.collection.CollectionUtils;
import com.store.ccsc.framework.test.core.ut.BaseDbUnitTest;
import com.store.ccsc.module.infra.api.file.FileApi;
import com.store.ccsc.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import com.store.ccsc.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import com.store.ccsc.module.system.controller.admin.user.vo.user.*;
import com.store.ccsc.module.system.dal.dataobject.dept.DeptDO;
import com.store.ccsc.module.system.dal.dataobject.dept.PostDO;
import com.store.ccsc.module.system.dal.dataobject.dept.UserPostDO;
import com.store.ccsc.module.system.dal.dataobject.user.AdminUserDO;
import com.store.ccsc.module.system.dal.mysql.dept.UserPostMapper;
import com.store.ccsc.module.system.dal.mysql.user.AdminUserMapper;
import com.store.ccsc.module.system.enums.common.SexEnum;
import com.store.ccsc.module.system.service.dept.DeptService;
import com.store.ccsc.module.system.service.dept.PostService;
import com.store.ccsc.module.system.service.permission.PermissionService;
...
import static com.store.ccsc.framework.common.util.collection.SetUtils.asSet;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("ccscyuanma");
        ...
        assertEquals("ccscyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("ccscyuanma"))).thenReturn("java");
