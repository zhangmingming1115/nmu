package com.store.ccsc.module.system.enums;
...
public interface ErrorCodeConstants {
    ...
    // ========== 工程投资管理 2-001-001-001 ==========
    ErrorCode INVESTMENT_MANAGEMENT_NOT_EXISTS = new ErrorCode(2-001-001, "工程投资管理不存在");
    ErrorCode INVESTMENT_MANAGEMENT_IMPORT_LIST_IS_EMPTY = new ErrorCode(2-001-002, "导入工程数据不能为空！");
    ErrorCode INVESTMENT_MANAGEMENT_EXISTS = new ErrorCode(2-001-003, "工程数据已经存在！");

    ErrorCode INCOME_STATEMENT_NOT_EXISTS = new ErrorCode(2-002-001, "收入清单不存在");
    ErrorCode INCOME_STATEMENT_IMPORT_LIST_IS_EMPTY = new ErrorCode(2-002-002, "导入收入清单数据不能为空！");
    ErrorCode TONG_FU_PROJECT_NOT_EXISTS = new ErrorCode(2-003-001, "通服项目不存在");
    ErrorCode TONG_FU_PROJECT_IMPORT_LIST_IS_EMPTY = new ErrorCode(2-003-002, "通服项目数据不能为空！");
    ErrorCode TONG_FU_PROJECT_EXISTS = new ErrorCode(2-003-003, "通服项目数据已经存在！");
